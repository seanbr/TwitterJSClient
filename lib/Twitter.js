...
Twitter.prototype.verifyCredentials = function(error, success) {
    var path = '/account/verify_credentials.json';
    var url = this.baseUrl + path;
    this.doRequest('get', url, error, success);
};
...
Twitter.prototype.sendTweet = function(params, error, success) {
    var path = '/statuses/update.json';
    var url = this.baseUrl + path;
    this.doRequest('post', url, error, success)
};

Twitter.prototype.doRequest = function (method, url, error, success) {
    this.oauth[method](url, this.accessToken, this.accessTokenSecret, function (err, body, response) {
